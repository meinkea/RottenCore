 ...
 */
  ...
  #include "inc/printHelp.h"

  #include "inc/test__array_add.h"
  #include "inc/test__array_ascl.h"
  #include "inc/test__array_asum.h"
  ...
  #include "inc/test__array_setscl.h"
  #include "inc/test__array_sub.h"
  #include "inc/test__array_swap.h"
  #include "inc/test__array_zero.h"


#endif // BLASxON__TESTCASES__LEVELZ__LVLZ_TEST_CASES_H
